...
public class Peripheral extends BluetoothGattCallback {
	...
	public void androidWrite(UUID serviceUUID, UUID characteristicUUID, byte[] data, Integer maxByteSize,
    			Integer queueSleepTime, boolean isSub, Callback callback, int writeType) {
    		if (!isConnected()) {
    			callback.invoke("Device is not connected", null);
    			return;
    		}
